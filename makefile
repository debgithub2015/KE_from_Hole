...
# -O3 optimize a lot
#
# -fcheck=all  -- check bounds and just about everything else you can imagine.
# -fbounds-check -- checks bounds on arrays
# -ftrapv -- traps overflow for arithmetic operations.
# -fexceptions -- enable excecption handling.
# -fnon-call-exceptions -- traps exceptions when possible
#
...
KeEx = kinds.o variables_wfn.o grid_vars.o KE_vars.o        \
          ...
          inout_module.o holesubroutinesUEGMEM.o            \
		  normalize_module_badBroyden.o	                    \
          KE_module_with_ExMEM.o main.o
...
holesubroutinesUEGMEM.o : holesubroutinesUEGMEM.f90
	$(COMP) -c $(FLAGS) holesubroutinesUEGMEM.f90

normalize_module_badBroyden.o : normalize_module_badBroyden.f90
	$(COMP) -c $(FLAGS) normalize_module_badBroyden.f90

KE_module_with_ExMEM.o : KE_module_with_ExMEM.f90
	$(COMP) -c $(FLAGS) KE_module_with_ExMEM.f90
